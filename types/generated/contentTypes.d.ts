...
export interface ApiConsultingConsulting extends Struct.SingleTypeSchema {
  collectionName: 'consultings';
  info: {
    description: '';
    displayName: '04_Consulting';
  ...
  attributes: {
    bulletPoint: Schema.Attribute.RichText & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiEcossistemaEcossistema extends Struct.SingleTypeSchema {
  collectionName: 'ecossistemas';
  info: {
    description: '';
    displayName: '03_Ecossistema';
    pluralName: 'ecossistemas';
    singularName: 'ecossistema';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    item: Schema.Attribute.Component<'page.item-ecossistema', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::ecossistema.ecossistema'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    subtitle: Schema.Attribute.RichText & Schema.Attribute.Required;
...
export interface ApiInGameInGame extends Struct.SingleTypeSchema {
  collectionName: 'in_games';
  info: {
    description: '';
    displayName: '05_InGame';
    pluralName: 'in-games';
    singularName: 'in-game';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiLevelLevel extends Struct.SingleTypeSchema {
  collectionName: 'levels';
  info: {
    description: '';
    displayName: '07_Level';
    pluralName: 'levels';
    singularName: 'level';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Level: Schema.Attribute.Component<'page.level', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiManifestoManifesto extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    subtitle: Schema.Attribute.RichText & Schema.Attribute.Required;
    subtitle2: Schema.Attribute.RichText & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::ecossistema.ecossistema': ApiEcossistemaEcossistema;
      'api::footer.footer': ApiFooterFooter;
      'api::hero.hero': ApiHeroHero;
      'api::in-game.in-game': ApiInGameInGame;
      'api::level.level': ApiLevelLevel;
      'api::manifesto.manifesto': ApiManifestoManifesto;
